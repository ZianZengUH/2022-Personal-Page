...
(This is a porject that is similar to what I had done: )<img width="400px" class="rounded float-start pe-4" src="../img/essays/arduino_project.png">
...
<img width="500px" class="rounded float-start pe-4" src="../img/essays/alpha_go.png">
